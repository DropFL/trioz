...
import com.dropfl.platformer.Synchronizer;
...
public class PlatformerActivity extends Activity
{
    ...
    public PlatformerActivity()
    {
        ...
        hpBar = ImageResource.HPBAR.getImageIcon().getImage().getScaledInstance(26, 400, Image.SCALE_FAST);
        shieldIco = ImageResource.SHIELDICO.getImageIcon().getImage().getScaledInstance(30, 30, Image.SCALE_FAST);
    ...
    public VolatileImage getScreen()
    {
        ...
        graphics.drawImage(ImageResource.HP.getImageIcon().getImage(), 1237, 199 + 4 * (100 - engine.getPlayerHp()), 24,
                engine.getPlayerHp() * 4 + 1, null);
