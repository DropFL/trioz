...
/**
 * {@code BoundingBox} defines some methods to describe a imaginary rectangular
 * hitarea. You can draw the bounding box of an object in this way:
 * 
 * <ol>
 ...
 * </ol>
 * 
 * Note that pivot of rotation in 3rd step is <strong>NOT</strong> the global
 * origin point (0, 0).
 * 
 * @see CollisionType
 */
public interface BoundingBox
{
    ...
    {
        return new Point(width(), height()).rotate(rotation()).add(x(), y());
    }
    ...
    {
        return new Point(width(), height()).multiply(0.5).rotate(rotation()).add(x(), y());
    }
}
