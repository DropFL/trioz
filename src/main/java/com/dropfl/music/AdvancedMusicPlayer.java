...
/**
 * {@code AdvancedMusicPlayer} is a complex, pausable version of
 * {@code MusicPlayer}. JLayer's {@code AdvancedPlayer} is used to implement
 * this class.
 */
public class AdvancedMusicPlayer extends MusicPlayer
{
    ...
    public int time()
    {
        int offset = (int) (pausedFrame * resource.msPerFrame());
        if (device != null)
            return device.getPosition() + offset;
        else
            return offset;
    }
